...
import { reportsService, AttendanceReportData, ReportFilters } from '../../api/reports';
...
const AttendanceReport: React.FC = () => {
  ...
  const generateReport = async () => {
    setLoading(true);
    try {
      const data = await reportsService.getAttendanceReport(filters);
      setReportData(data);
    } catch (error) {
  ...
  const handleExport = async (format: 'excel' | 'pdf') => {
    setExporting(true);
    try {
      const blob = await reportsService.exportAttendanceReport(filters, format);
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Track employee attendance patterns and statistics</p>
        </div>
          ...
          <div className="bg-white p-4 rounded-lg border">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-2xl font-semibold text-gray-900">{reportData.statistics.totalDays}</p>
              </div>
            </div>
          </div>
          <div className="bg-white p-4 rounded-lg border">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-2xl font-semibold text-gray-900">{reportData.statistics.presentDays}</p>
              </div>
            </div>
          </div>
          <div className="bg-white p-4 rounded-lg border">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-2xl font-semibold text-gray-900">{reportData.statistics.absentDays}</p>
              </div>
            </div>
          </div>
          <div className="bg-white p-4 rounded-lg border">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-2xl font-semibold text-gray-900">{reportData.statistics.lateDays}</p>
              </div>
            </div>
          </div>
          <div className="bg-white p-4 rounded-lg border">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-2xl font-semibold text-gray-900">{reportData.statistics.totalHours.toFixed(1)}</p>
              </div>
            </div>
          </div>
          <div className="bg-white p-4 rounded-lg border">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-2xl font-semibold text-gray-900">{reportData.statistics.overtimeHours.toFixed(1)}</p>
              </div>
            </div>
          </div>
        </div>
